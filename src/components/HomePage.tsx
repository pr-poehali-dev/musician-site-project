        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <h1 className="md:text-6xl text-vintage-dark-brown font-extrabold text-center my-[9px] text-xl px-[23px]">Я сочиняю песни. Это любимое занятие, потому что оно учит меня принимать неожиданность, быть внимательнее к мелочам, доверять процессу и себе. И каждый раз, когда финальная нота растворяется в тишине, я знаю — впереди снова пустая страница, новый аккорд</h1>
