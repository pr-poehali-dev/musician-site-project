  ...
  return (
    <section id="albums" className="py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-vintage-warm/10 border border-vintage-brown/20 rounded-lg p-4 mb-8 max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
